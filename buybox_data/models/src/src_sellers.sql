...
flatten_payload as(
    select raw_data:"Payload"::Object:"AnyOfferChangedNotification"::Object:"Offers"::ARRAY as offer from source_data
)
select offer.value:"SellerId"::STRING as SellerId,
